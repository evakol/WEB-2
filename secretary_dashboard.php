...
// Παίρνουμε τα στοιχεία του γραμματέα
...
<body>
    ...
    <script>
        // ΑΛΛΑΓΗ 1: Διόρθωση των διαδρομών για τα PHP αρχεία
        // Αφαίρεσα τις διαδρομές '../secretary/' και τις έκανα απλά 'secretary/'
        ...
        // ΑΛΛΑΓΗ 2: Προσθήκη καλύτερου error handling
        ...
        // ΑΛΛΑΓΗ 3: Διόρθωση διαδρομής για το 1getTheses.php
        ...
        // ΑΛΛΑΓΗ 4: Διόρθωση διαδρομής για το 2postJson.php
        function submitJson() {
...
Καθηγητές: ${result.stats.professors_imported}/${data.professors.length}
Φοιτητές: ${result.stats.students_imported}/${data.students.length}

Σημείωση: Δημιουργήθηκαν αυτόματα username/password για όλους τους χρήστες.`;
        ...
        // ΑΛΛΑΓΗ 5: Διόρθωση διαδρομής για το 3getTheses.php
        ...
        // ΑΛΛΑΓΗ 6: Βελτίωση της φόρμας διαχείρισης
        function renderManagementForm() {
            ...
            if (status == 2) {
                form.innerHTML = `
                    ...
                    <div class="form-group">
                        <label>ΑΠ απόφασης ΓΣ ανάθεσης:</label>
                        <input type="number" id="gsApprovalNumber" placeholder="π.χ. 123" required>
                        <small style="color: #7f8c8d; display: block; margin-top: 5px;">
                            Καταχωρήστε τον αριθμό της απόφασης της Γενικής Συνέλευσης
                        </small>
                    </div>
                    <div class="form-group">
                    ...
                    <div id="cancelFields" style="display:none;">
                        <div class="form-group">
                            <label>ΑΠ απόφασης ΓΣ ακύρωσης:</label>
                            <input type="number" id="gsCancelNumber" placeholder="π.χ. 456">
                        </div>
                        <div class="form-group">
                            <label>Λόγος ακύρωσης:</label>
                            <textarea id="cancelReason" rows="3" placeholder="Αναφέρετε τον λόγο ακύρωσης...">Κατόπιν αίτησης Φοιτητή/τριας</textarea>
                        </div>
                    </div>
            ...
            if (status == 3) {
                form.innerHTML = `
                    ...
                    <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
                        <h4 style="color: #495057; margin-bottom: 10px;">Προϋποθέσεις για περάτωση:</h4>
                        <ul style="color: #6c757d; margin-left: 20px;">
                            <li>Να έχει καταχωρηθεί βαθμός από την τριμελή επιτροπή</li>
                            <li>Να έχει αναρτηθεί σύνδεσμος προς το αποθετήριο Νημερτή</li>
                        </ul>
                    </div>
        ...
        // ΑΛΛΑΓΗ 7: Διόρθωση διαδρομής για το 3manageActiveThesis.php
        ...
        // ΑΛΛΑΓΗ 8: Διόρθωση διαδρομής για το 3manageUnderReviewThesis.php
        ...
        // ΑΛΛΑΓΗ 9: Προσθήκη initialization
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Secretary dashboard loaded successfully');
            // ΑΛΛΑΓΗ 10: Προσθήκη έλεγχου σύνδεσης
            fetch('secretary/1getTheses.php')
                .then(response => {
                    if (!response.ok) {
                        console.warn('Warning: Secretary endpoints may not be accessible');
                    }
                })
                .catch(error => {
                    console.error('Error checking secretary endpoints:', error);
                });
        });
    </script>
</body>
